        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                Password is optional. You can use OTP-only authentication.
              </p>
            </div>
            ...
            >
              {loading ? 'Processing...' : 'Continue with Email OTP'}
            </button>
          </form>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-700 font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg border border-slate-300"
            >
